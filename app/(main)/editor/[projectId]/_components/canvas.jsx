...
// useRef is a hook which enables us to get access to a particular element through DOM.
...
function CanvasEditor({ project }) {
  ...
  const { canvasEditor, setCanvasEditor, activeTool, onToolChange } =
    useCanvas();
  const [isLoading, setIsLoading] = useState(true); //by default at the beginning the loading is true
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          // complex css responsible for checkered background
          backgroundImage: `
